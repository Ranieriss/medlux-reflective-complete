...
export const invalidSupabaseEnvVars = [
  supabaseUrl && !isValidSupabaseUrl
    ? "VITE_SUPABASE_URL (esperado formato https://<project-ref>.supabase.co)"
    : null,
  looksLikeProjectRef
    ? `${supabaseKeySource || "VITE_SUPABASE_ANON_KEY"} (valor prj_... não é chave pública válida)`
    : null,
  isPublishableKey
...
export const hasSupabaseEnv =
  missingSupabaseEnvVars.length === 0 && invalidSupabaseEnvVars.length === 0;
